<template>
    <div class="quick-container">
        <demo class="username-input" :username="'yy'" @enlarge-text="getUserList()"></demo>
        <el-card class="quick-card">
            <div slot="header">
                <span>用户列表</span>
                <el-button size="mini" class="add-user__button" type="primary" @click="openAddUserDialog()">用户添加
                </el-button>
            </div>
            <div class="card-text">
